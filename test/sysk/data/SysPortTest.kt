...
class SysPortTest {
    ...
    fun SysBusPort() {
        ...
        connector.addWire()
        connector.addWire()
        val port_1 = sysk.connectors.SysBusPort("port1", null, connector)
        val port_2 = sysk.connectors.SysBusPort("port2", null, connector)
        val port_3 = sysk.connectors.SysBusPort("port3", null, connector)
        assert(port_1[0].x)
        assert(port_2[1].x)
        assert(port_3[2].x)
